...
- Art for the Stakeman loads from `assets/characters/stakeman/stakeman_sheet.png` (and its JSON) in the hunter sheet layout: 64×64 cells, column 0 idle, columns 1–6 walk, eight facings. The hunter stays on `assets/player_sheet.png` (68×68). A failed Stakeman image still draws the hunter sheet darker.
